...
import { Plus, Search, Filter, Trash2, Edit, FileSpreadsheet, Calendar } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
              <Button className="font-bold w-full bg-orange-600 hover:bg-orange-700 shadow-lg shadow-orange-600/20">
              ...
              {filteredStudents.length === 0 && (
                <TableRow>
                  <TableCell colSpan={5} className="h-32 text-center text-muted-foreground">
                    No cumulative final results found matching the filters.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
