...
import { Plus, Search, Filter, Trash2, Edit, ClipboardList, Calendar } from "lucide-react";
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>{editingStudent ? "Edit Record" : "Add Quarterly Record"}</DialogTitle>
              </DialogHeader>
            ...
            <TableBody>
              {filteredStudents.map((s) => (
                <TableRow key={s.id}>
                  ...
                  <TableCell className="text-center font-bold">85/100</TableCell>
                  <TableCell className="text-center">
                    <Badge className="bg-green-500 font-bold">A</Badge>
                  </TableCell>
